...
public class AgendaGenerator {
	 ...
	 * @param expandedTasks
	 */
	private static String expandRecursively(Project p,CalendarDate date, ITaskList tl,ITask t, Collection expandedTasks, int level) {
	 ...
	 * @return
	 */
	private static String renderTask(Project p, CalendarDate date, ITaskList tl, ITask t, int level, Collection expandedTasks) {
		String s = "";
