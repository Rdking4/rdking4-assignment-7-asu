...
import main.java.memoranda.interfaces.IEventsScheduler;
import main.java.memoranda.interfaces.History;
import main.java.memoranda.interfaces.HistoryItem;
...
public class DailyItemsPanel extends JPanel {
    ...
    void jbInit() throws Exception {
        ...
        ACurrentProject.addProjectListener(new ProjectListener() {
            public void projectChange(Project p, NoteList nl, ITaskList tl, ResourcesList rl) {
...
//                // DEBUG
        ...
        ACurrentNote.addNoteListener(new NoteListener() {
        ...
        IEventsScheduler.addListener(new IEventNotificationListener() {
        ...
        editorPanel.setDocument(currentNote);
        History.add(new HistoryItem(CurrentDate.get(), ACurrentProject.get()));
    ...
    void currentDateChanged(CalendarDate newdate) {
        ...
        if (!changedByHistory) {
           History.add(new HistoryItem(newdate, ACurrentProject.get()));
		}
...
//		Util.debug("currentNoteChanged");
    ...
    void currentProjectChanged(Project newprj, NoteList nl, ITaskList tl, ResourcesList rl) {
//		Util.debug("currentProjectChanged");
    ...
    public void updateIndicators(CalendarDate date, ITaskList tl) {
        ...
        if (date.equals(CalendarDate.today())) {
            ...
            if (IEventsScheduler.isEventScheduled()) {
                /*String evlist = "";
                ...
                main.java.memoranda.interfaces.AEvent ev = IEventsScheduler.getFirstScheduledEvent();
