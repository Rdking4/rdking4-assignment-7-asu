...
import main.java.memoranda.interfaces.NoteListImpl;
...
import main.java.memoranda.interfaces.ResourcesListImpl;
...
//        CalendarDate d = note.getDate();
    ...
    public ITaskList openTaskList(Project prj) {
    ...
    public void storeTaskList(ITaskList tasklist, Project prj) {
        /*DEBUG*/
        System.out.println(
